  ...
  $('#masque-parchemin').mouseleave(function(){
    ...
    var creationDecor = function(){
      ...
      if(masque.style.transform==="scaleX(1)" && animationNinja && ninjaCourSansLancerDeShuriken && personnage.style.left != "0px"){
          ...
          $("#arriereplan").css({left:arriereplan});
